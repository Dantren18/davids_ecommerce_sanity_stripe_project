## Full Stack ECommerce Application using Stripe for payments & Sanity for backend

**Features**.

- Ability to add new products and edit other elements of the website instantly using sanity.
- Payments accepted with Stripe integration
- Use of react-smooth-scroll to direct to correct categories on the page
- Responsive deign to work on both desktop and mobile
- Hosted (work in progress) version can be viewed here: https://davids-ecommerce-sanity-stripe-project-a2k9.vercel.app/
